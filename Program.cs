...
namespace ConsoleApp.Word.AddImage
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string imagePath = CurrentDirectory + @"\Sample_Files\test.png";
            string docPath = CurrentDirectory + @"\Sample_Files\test.docx";

            string newDocPath = CurrentDirectory + @"\Sample_Files\test-new.docx";
